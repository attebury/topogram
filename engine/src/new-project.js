...
function writeProjectPackage(projectRoot, engineRoot) {
  const pkg = {
    ...
    type: "module",
    scripts: {
      check: "npm run topogram:check",
      generate: "npm run topogram:generate",
      verify: "npm run app:compile",
      bootstrap: "npm run app:bootstrap",
      dev: "npm run app:dev",
      "topogram:check": "topogram check ./topogram",
      "topogram:generate": "topogram generate ./topogram --out ./app",
