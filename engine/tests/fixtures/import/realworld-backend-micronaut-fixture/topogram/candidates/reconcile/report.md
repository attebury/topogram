...
- `article-tag`: Liquibase implementation-noise join table for article-tag linkage.
- `follow-relation`: Liquibase implementation-noise join table for follow relationships.
- `article-favorite`: Liquibase implementation-noise join table for article favorites.
...
- `article` (0 actors, 0 roles, 1 entities, 0 enums, 8 capabilities, 9 shapes, 0 screens, 1 workflows, 0 docs)
- `comment` (0 actors, 0 roles, 1 entities, 0 enums, 3 capabilities, 3 shapes, 0 screens, 1 workflows, 0 docs)
- `profile` (0 actors, 0 roles, 0 entities, 0 enums, 3 capabilities, 3 shapes, 0 screens, 1 workflows, 0 docs)
- `tag` (0 actors, 0 roles, 1 entities, 0 enums, 1 capabilities, 1 shapes, 0 screens, 1 workflows, 0 docs)
- `user` (0 actors, 0 roles, 1 entities, 0 enums, 3 capabilities, 5 shapes, 0 screens, 1 workflows, 0 docs)
