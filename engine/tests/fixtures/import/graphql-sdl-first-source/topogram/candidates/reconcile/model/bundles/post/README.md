...
- `entity_post` from `orm/graphql-sdl-first/prisma/schema.prisma`

## API Evidence

- `cap_create_post` at `POST /`
- `cap_delete_post` at `POST /`
- `cap_get_post` at `GET /`
- `cap_list_posts` at `GET /`
- `cap_publish_post` at `POST /`
- `cap_update_post_view_count` at `POST /`
