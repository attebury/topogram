...
- Promote capabilities: `cap_create_post`, `cap_delete_post`, `cap_get_post`, `cap_list_posts`, `cap_publish_post`
- Promote shapes: `shape_input_create_post`, `shape_input_delete_post`, `shape_input_get_post`, `shape_input_publish_post`, `shape_output_create_post`, `shape_output_delete_post`, `shape_output_get_post`, `shape_output_list_posts`, `shape_output_publish_post`
...
- `entity_post` from `engine/tests/fixtures/import/nextjs-graphql-source/prisma/schema.prisma`
