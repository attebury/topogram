...
- Promote shapes: `shape_input_create_comment`, `shape_output_create_comment`, `shape_output_delete_comment`, `shape_output_list_comments`
...
- `promote_shape` `shape_output_delete_comment`
...
- `entity_comment` from `src/main/resources/db/migration/V1__create_tables.sql`

## API Evidence

- `cap_create_comment` at `POST /articles/{slug}/comments`
- `cap_delete_comment` at `DELETE /articles/{slug}/comments/{id}`
- `cap_list_comments` at `GET /articles/{slug}/comments`
