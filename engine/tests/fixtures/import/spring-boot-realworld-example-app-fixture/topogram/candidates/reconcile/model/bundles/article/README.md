...
- Promote shapes: `shape_input_create_article`, `shape_output_create_article`, `shape_output_delete_article`, `shape_output_favorite_article`, `shape_output_unfavorite_article`, `shape_output_update_article`
...
- `promote_shape` `shape_output_delete_article`
...
- `entity_article` from `src/main/resources/db/migration/V1__create_tables.sql`
