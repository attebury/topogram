...
- Promote shapes: `shape_input_create_article`, `shape_input_update_article`
...
- `entity_article` from `src/main/java/org/example/realworldapi/infrastructure/repository/hibernate/entity/ArticleEntity.java`
