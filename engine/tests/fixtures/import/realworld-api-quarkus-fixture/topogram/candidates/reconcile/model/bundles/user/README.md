...
- Promote shapes: `shape_input_create_user`, `shape_input_update_user`
...
- `entity_user` from `src/main/java/org/example/realworldapi/infrastructure/repository/hibernate/entity/UserEntity.java`
