...
- `article`: blocked=0, approved=0, applied=13, pending=0, dependencies=_none_
- `comment`: blocked=0, approved=0, applied=7, pending=0, dependencies=_none_
- `profile`: blocked=0, approved=0, applied=5, pending=0, dependencies=_none_
- `tag`: blocked=0, approved=0, applied=4, pending=0, dependencies=_none_
- `user`: blocked=0, approved=0, applied=8, pending=0, dependencies=_none_
...
- `favorite-relationship`: JPA implementation-noise child entity.
- `follow-relationship`: JPA implementation-noise child entity.
- `tag-relationship`: JPA implementation-noise child entity.
...
- `article` (0 actors, 0 roles, 1 entities, 0 enums, 8 capabilities, 2 shapes, 0 screens, 1 workflows, 0 docs)
- `comment` (0 actors, 0 roles, 1 entities, 0 enums, 3 capabilities, 1 shapes, 0 screens, 1 workflows, 0 docs)
- `profile` (0 actors, 0 roles, 0 entities, 0 enums, 3 capabilities, 0 shapes, 0 screens, 1 workflows, 0 docs)
- `tag` (0 actors, 0 roles, 1 entities, 0 enums, 1 capabilities, 0 shapes, 0 screens, 1 workflows, 0 docs)
- `user` (0 actors, 0 roles, 1 entities, 0 enums, 3 capabilities, 2 shapes, 0 screens, 1 workflows, 0 docs)
