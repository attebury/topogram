...
- `follow`: Spring implementation-noise join table for follow relationships.
- `article-tag`: Spring implementation-noise join table for article-tag linkage.
- `favorite`: Spring implementation-noise join table for article favorites.
