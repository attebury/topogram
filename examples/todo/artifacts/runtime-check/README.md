...
This bundle gives you richer staged runtime verification for the generated Todo stack.
...
- `environment`: required env, web readiness, API health, API readiness, DB-backed seeded task lookup
- `api`: core task happy paths, export/job flows, generated lookup endpoints, and a few important negative cases
