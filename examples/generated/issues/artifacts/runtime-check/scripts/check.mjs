...
function envValue(name) {
  ...
  const fallbackMap = {
    ...
    TOPOGRAM_DEMO_PRIMARY_ID: process.env.PUBLIC_TOPOGRAM_DEMO_PRIMARY_ID || process.env.PUBLIC_TOPOGRAM_DEMO_TASK_ID || "",
...
function inferPathParams(contract, overrides = {}) {
  ...
  for (const field of contract.requestContract?.transport?.path || []) {
    ...
    if (field.name === "task_id" || field.name === "issue_id") {
