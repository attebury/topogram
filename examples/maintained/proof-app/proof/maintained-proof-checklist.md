...
Use this checklist when adding a new hand-maintained proof under `examples/maintained/proof-app`.
...
- [examples/maintained/proof-app/scripts/emitted-contracts.mjs](../scripts/emitted-contracts.mjs)
...
- [examples/maintained/proof-app/scripts/proof-scenarios.mjs](../scripts/proof-scenarios.mjs)
...
- [examples/maintained/proof-app/proof](./)

7. Update the written proof story.

At minimum, update:

- [examples/maintained/proof-app/README.md](../README.md)
- [examples/maintained/proof-app/proof/edit-existing-app.md](./edit-existing-app.md)
...
If a new proof would mostly duplicate a generated example, it probably belongs in generated example verification instead of `examples/maintained/proof-app`.
