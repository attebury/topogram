...
The canonical journey [issue-resolution-and-closure.md](../../../../examples/generated/issues/topogram/docs/journeys/issue-resolution-and-closure.md) reinforces the same intent:
