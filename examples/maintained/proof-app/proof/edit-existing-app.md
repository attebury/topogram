...
- maintained app presenter in `examples/maintained/proof-app/src/content-approval.js`
- maintained app workflow guard in `examples/maintained/proof-app/src/content-approval-change-guards.js`
- documented DB and maintained-app proof story in `examples/maintained/proof-app/proof/content-approval-db-change-story.md`
...
- task `priority`
  ...
  - maintained app presenter in `examples/maintained/proof-app/src/todo.js` renders the new field in both task detail and maintained task-card/list summaries
- project `owner_id`
...
- issue detail ownership visibility
  ...
  - maintained presenter in `examples/maintained/proof-app/src/issues.js` mirrors that behavior by showing edit/close affordances for owner or admin, and hiding them for non-owner viewers
- issue list/card visibility
  ...
  - maintained presenter in `examples/maintained/proof-app/src/issues.js` mirrors that card/list surface so “find it again in list and detail” remains part of the hand-maintained proof
- issue cross-surface alignment
  ...
  - maintained presenter in `examples/maintained/proof-app/src/issues.js` now carries an explicit cross-surface alignment helper so those surfaces move as one governed seam family
...
- maintained modules:
  - `examples/maintained/proof-app/src/content-approval.js`
