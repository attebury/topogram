# Maintained Proof App

This folder is Topogram's maintained example app.

It lives under `examples/maintained` because it proves governed change in human-owned code, not generator-owned output and not imported brownfield recovery.
...
Run these from `./examples/maintained/proof-app`.
...
- changing `examples/maintained/proof-app`
- changing Topogram-generated contract surfaces that `examples/maintained/proof-app` mirrors
- changing proof stories under `examples/maintained/proof-app/proof`
