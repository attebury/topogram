...
export function createApp(deps: ServerDependencies) {
  ...
  app.post(route3.path, async (c) => {
    try {
      ...
      const loadAuthorizationResource3 = async () => await deps.articleRepository.getArticle({ article_id: String(input.article_id || "") } as unknown as GetArticleInput) as unknown as Record<string, unknown>;
  ...
  app.post(route4.path, async (c) => {
    try {
      ...
      const loadAuthorizationResource4 = async () => await deps.articleRepository.getArticle({ article_id: String(input.article_id || "") } as unknown as GetArticleInput) as unknown as Record<string, unknown>;
      await deps.authorize?.(c, route4.endpoint.authz, { capabilityId: route4.capabilityId, input, loadResource: typeof loadAuthorizationResource4 === "function" ? loadAuthorizationResource4 : undefined });
  ...
  app.post(route5.path, async (c) => {
    try {
      ...
      const loadAuthorizationResource5 = async () => await deps.articleRepository.getArticle({ article_id: String(input.article_id || "") } as unknown as GetArticleInput) as unknown as Record<string, unknown>;
      await deps.authorize?.(c, route5.endpoint.authz, { capabilityId: route5.capabilityId, input, loadResource: typeof loadAuthorizationResource5 === "function" ? loadAuthorizationResource5 : undefined });
