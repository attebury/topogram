# Topogram Content Approval App Bundle
...
4. Open the web app at `http://localhost:5175/articles`
5. Confirm the seeded "Editorial Desk" and "Seeded Demo Article" flow through the stack
