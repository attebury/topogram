...
export async function listPrimaryResources(fetcher: Fetcher, input: Record<string, unknown> = {}) {
  return requestCapability(fetcher, "cap_list_articles", input);
}
export async function listArticles(fetcher: Fetcher, input: Record<string, unknown> = {}) {
  return listPrimaryResources(fetcher, input);
}

export async function getPrimaryResource(fetcher: Fetcher, primary_id: string) {
  return requestCapability(fetcher, "cap_get_article", { article_id: primary_id });
}
export async function getArticle(fetcher: Fetcher, primary_id: string) {
...
export async function createPrimaryResource(fetcher: Fetcher, input: Record<string, unknown>, options: RequestOptions = {}) {
  return requestCapability(fetcher, "cap_create_article", input, options);
}
export async function createArticle(fetcher: Fetcher, input: Record<string, unknown>, options: RequestOptions = {}) {
...
export async function updatePrimaryResource(fetcher: Fetcher, primary_id: string, input: Record<string, unknown> = {}, options: RequestOptions = {}) {
  return requestCapability(fetcher, "cap_update_article", { article_id: primary_id, ...input }, options);
}
export async function updateArticle(fetcher: Fetcher, primary_id: string, input: Record<string, unknown> = {}, options: RequestOptions = {}) {
...
export async function terminalPrimaryAction(fetcher: Fetcher, primary_id: string, input: Record<string, unknown> = {}, options: RequestOptions = {}) {
  return requestCapability(fetcher, "cap_approve_article", { article_id: primary_id, ...input }, options);
}
