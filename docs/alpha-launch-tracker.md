...
| Maintained-app proof package is the strongest demo stop | `proof_owner` | `in_progress` | yes | no | Safe, guarded, and no-go stories remain easy to navigate and seam-aware | [product/app/proof/edit-existing-app.md](../product/app/proof/edit-existing-app.md), [skeptical-evaluator.md](./skeptical-evaluator.md) |
