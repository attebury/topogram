# Topogram — full orientation

Start at the repository **[README](../README.md)** for the **product workflow** (diagram, capability matrix, where proofs live). This page is the deeper companion: motivation, limits, proof inventory, FAQ, and commands.
...
For collaboration and workspace boundaries, see [human-agent-collaboration.md](./human-agent-collaboration.md) and [topogram-workspace-layout.md](./topogram-workspace-layout.md).
...
The old `trials/` tree has been retired from the product repo. Product-side importer regression now runs from curated fixtures under `engine/tests/fixtures/import`; see [import-fixtures-inventory.md](./import-fixtures-inventory.md) and [remaining-trial-policy.md](./remaining-trial-policy.md).
...
Imported brownfield **breadth** and **native full-stack parity** proofs run in **[topogram-demo](https://github.com/attebury/topogram-demo)** (see [docs/topogram-demo-ops.md](./docs/topogram-demo-ops.md)), not in the commands below.
...
- [docs](./): planning notes, proof summaries, and architecture/reference docs
...
See the repository [README](../README.md#license) and [LICENSE](../LICENSE).
